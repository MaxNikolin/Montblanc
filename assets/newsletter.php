...
$e_subject = 'Новый запрос на подписку';

// You can change this if you feel that you need to.
$e_body = " $email_newsletter_2 хочет подписаться на обновление новостей" . PHP_EOL . PHP_EOL;
...
$usersubject = "Спасибо";
$userheaders = "From: Montblanc.tours.minsk@gmail.com\n";
...
$usermessage = "Спасибо, что выбрали Нашу компанию!";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "Спасибо <strong>$email_newsletter</strong>, Ваш Email подписан на обновление свежих новостей от нашей компании!";
	echo "</div>";
